...
# Load data
interval = '5m'  # Change this to switch between different intervals ('1d', '1h', '5m')
index_col = 'Datetime' if interval in ['1h', '5m'] else 'Date'
...
# Extract and print the best accuracy, best val accuracy, best val loss, and best loss
